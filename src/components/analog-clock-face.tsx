...
const AnalogClockFace = () => {
    ...
    return (
        <div className="relative w-36 h-36 md:w-48 md:h-48">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-[0.75] md:scale-100">
                <div className="relative w-48 h-48">
                    ...
                    <div className="relative w-full h-full rounded-full bg-[#fdebe4] border-[12px] border-[#e53935] shadow-lg">
                        ...
                        <div className="absolute top-[60%] left-1/2 -translate-x-1/2 text-center font-clock text-[11px] text-[#00E5E5] z-10" style={{ textShadow: '0 0 3px #00E5E5' }}>
                            Adrian <br /> bash
                        </div>
